...
_See the the [Badges](../configuration/configuration.md#Badges) section of the configuration page for information about accessing the badges._

If you are publishing [Provider verification results](../advanced_topics/provider_verification_results.md) to your Pact Broker (v2.3.0+), you can also display the verification status in your READMEs using a shiny badge like this one:
